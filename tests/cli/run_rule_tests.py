...
from deterministic.core.rules_engine import (
    load_all_rules,
...
TESTS_DIR = ROOT.parent / "artifacts" / "generated"
...
def main() -> int:
    ...
    if not files:
        _fail("No test files found in tests/artifacts/generated")
